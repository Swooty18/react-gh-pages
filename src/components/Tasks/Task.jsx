...
const Task = ({ id, text ,completed,onEditTask,onCompleteTask, onRemoveTask,list}) => {
    const onChangeCheckBox= e => {
        onCompleteTask(list.id,id,e.target.checked);
      } 
    return (
        <div>
            <div key={id} className="tasks-items">
            <label htmlFor={id}></label>
                <div className="checkbox">
                <input  id={id}  onChange={onChangeCheckBox} type="checkbox" checked={completed}/>
                </div>
                <div className="tasks-items-text"><p>{text}</p></div>
                <div className="tasks-items-actions">
